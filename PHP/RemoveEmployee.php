...
<body>
    ...
    <div class="sidenav" style="margin-top: 100px">
		...
		<a href="RemoveEmployee.php" class="active">Remove Employee</a>
	...
	<form action="../PHP/RemEmp.php" method="POST" align="center">
		...
		<input type="submit" name="RemoveEmp"  value="Remove"style="padding: 10px;border-radius: 5px;border-width: 1px;margin-top: 30px;widows: 250px;height: 40px;background-color: red;color: white;font-style: bold;font-family: sans-serif;"><br>
	</form>
    </div>
    ...
    <?php
        if (isset($_GET["name"])){
            $code = $_GET["name"];
            echo "<h3>Employee Name -  ". $code . "  is Removed .</h3>" ;
        }
        else{
            if(isset($_GET["status"])){
            $code = $_GET["status"];
            echo "<h3>There is No Employee With Id = "  . $code . "</h3>";
            }
        }
    ?>    
    </div>
